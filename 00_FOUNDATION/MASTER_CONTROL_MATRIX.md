...
The Master Control Matrix (MCM) is the **sole, non-derivative, authoritative source** for all governance control definitions within the Enterprise AI-Aligned Technical Governance Framework (EATGF).

The MCM:

- Defines the only official taxonomy of governance controls (35 controls across 11 domains)
- Establishes unique control identifiers using the EATGF-[DOMAIN]-[CATEGORY]-[NUMBER] format
- Specifies control objectives, evidence requirements, ownership, and review frequency
- Provides the foundation for ISO 27001 Statement of Applicability, ISO 42001 compliance, and audit readiness
- Serves as the central control hub to which all EATGF documents (Layers 01-08) trace their governance authority

No other EATGF document defines controls. All governance documents either reference MCM controls, interpret MCM controls in specific contexts, or implement MCM controls through operational procedures.
...
**Authority Scope:** This document is the authoritative source for all governance controls applicable to Layers 00 through 08 (all EATGF governance and developer governance layers).

**Control Authority Relationship (Non-Derivative):**

- The MCM does not inherit control authority from any other document
- The Governance Charter (Layer 04) recognizes the MCM's authority; it does not grant it
- The MCM cannot be superseded, modified, or reinterpreted by any layer below it
- All downstream changes (new policies, standards, profiles) must reference MCM control IDs -- they cannot define new controls

**Dependency Model:**

- **Upstream:** None. The MCM is the root.
- **Downstream:** Every Layer 01-08 document derives its control identity from the MCM
- **Cross-layer:** The Governance Charter (Layer 04) establishes organizational authority to adopt the MCM framework

---

## Governance Principles (MCM-Specific)

1. **Control Singularity** -- Only the MCM is authorized to define governance controls. No parallel control taxonomies, frameworks, or definitions are permitted within EATGF authority.

2. **Version Immutability** -- Changes to MCM control definitions constitute a major framework version increment. All dependent documents must be re-validated when MCM version changes.

3. **Formal Change Governance** -- Modifications to control definition, ownership, or evidence requirements require Board-level change approval via Governance Charter authority.

4. **Audit Traceability** -- Every control includes explicit evidence requirements, control owner assignment, and review frequency. These elements are auditable and non-optional.

5. **Control-Domain Integrity** -- Controls are grouped into 11 domains (EDM, APO, BAI, DSS, MEA, CLD, DEV, DATA, BCP, AI, API) aligned to COBIT 2019. Domain structure cannot be reorganized without major framework revision.

6. **Cross-Standard Alignment Discipline** -- All MCM controls are mapped to ISO 27001:2022, NIST SP 800-218, OWASP, and COBIT 2019. Mappings are maintained in separate reference documents (CONTROL_MAPPING_APPENDIX, FRAMEWORK_MAPPINGS_COMPREHENSIVE_v2) to preserve MCM simplicity.
...
The **Master Control Matrix** contains **35 core governance controls** organized into **11 domains** aligned to COBIT 2019:

| Domain                    | Code | Description                                             | Number of Controls |
| ------------------------- | ---- | ------------------------------------------------------- | ------------------ |
| Evaluate, Direct, Monitor | EDM  | Board-level governance and risk appetite                | 5                  |
| Align, Plan, Organize     | APO  | Strategy, architecture, and organizational design       | 7                  |
| Build, Acquire, Implement | BAI  | Development, acquisition, and implementation of systems | 6                  |
| Deliver, Service, Support | DSS  | Operations and security controls                        | 5                  |
| Monitor, Evaluate, Assess | MEA  | Performance monitoring and internal audit               | 4                  |
| Cloud Governance          | CLD  | Cloud platform governance and compliance                | 2                  |
| DevSecOps & Development   | DEV  | Secure development lifecycle and CI/CD                  | 2                  |
| Data Privacy & Protection | DATA | Privacy and data lifecycle controls                     | 2                  |
| Business Continuity & DR  | BCP  | Resilience and disaster recovery                        | 2                  |
| AI-Specific Governance    | AI   | AI system governance and responsible AI                 | 1                  |
| API Security & Lifecycle  | API  | API governance and security                             | 1                  |

**Total: 35 Controls**

Each control is defined with:

- Unique identifier (EATGF-[DOMAIN]-[CATEGORY]-[NUMBER])
- Control title and detailed description
- Governance domain and control type
- Reference standards (COBIT, ISO 27001, ISO 42001, NIST, OWASP)
- Evidence requirements
- Control owner and evidence owner roles
- Review frequency
- Applicability profiles (Startup / SaaS / Enterprise)
- Environment applicability (Cloud / Hybrid / On-Prem / Multi-Cloud)
- Criticality level
...
The MCM itself serves as the master control definition authority. All external framework alignments are documented in separate reference materials:
...
| Standard/Framework | Version    | Coverage                                                      |
| ------------------ | ---------- | ------------------------------------------------------------- |
| ISO/IEC 27001:2022 | 2022       | Information security management system (Annex A: 76 controls) |
| NIST SP 800-218    | Current    | Secure software development framework (SSDF)                  |
| NIST SP 800-53     | Revision 5 | Security and privacy controls                                 |
| COBIT 2019         | 2019       | Governance of enterprise IT (EDM/APO/BAI/DSS/MEA domains)     |
| ISO/IEC 42001:2023 | 2023       | AI management system                                          |
| OWASP ASVS         | 4.0        | Application security verification standard                    |

**How This Works:**

Each of the 35 MCM controls is mapped to:

1. Applicable COBIT 2019 process ID(s)
2. Applicable ISO 27001:2022 Annex A clause(s)
3. Applicable NIST SP 800-218 practices
4. Applicable OWASP guidance (where relevant)

These mappings are maintained in the separate reference documents to preserve MCM simplicity and auditability.

---

## Developer Checklist (MCM Enforcement)

These checks ensure MCM singularity is maintained across the entire EATGF framework:

- [ ] **No Duplicate Control Definitions** -- Verify that no other EATGF document (Layers 01-08) defines governance controls. All controls originate from the MCM.
- [ ] **All Policies Reference MCM Control IDs** -- Confirm that every policy document (Layer 04) and standard (Layer 08) explicitly traces its requirements back to MCM control IDs.
- [ ] **All Audits Scope from MCM** -- Verify that audit procedures (Layer 06) use the MCM's 35 controls as the audit scope baseline, not alternative control lists.
- [ ] **All SDLC/API/Infrastructure Annexes Reference MCM** -- Confirm that technical annexes and profiles (Layer 08) link their requirements to parent MCM control domains.
- [ ] **All Evidence Tracking Uses MCM Control IDs** -- Verify that the evidence repository and compliance tracking system organize evidence by official MCM control identifier.
- [ ] **MCM Version Tracked in All Dependent Documents** -- Confirm that every document referencing the MCM declares which MCM version it was validated against.
- [ ] **No Alternative Control Taxonomies Exist** -- Search across all repositories and document systems for competing control frameworks. Result should be: None found.

---

## Governance Implications (MCM Divergence Risks)

**Risk if MCM diverges from itself:** If duplicate control definitions emerge in other documents:

- Audit scope becomes ambiguous (which controls are authoritative?)
- Compliance claims become indefensible (which control taxonomy do we claim compliance with?)
- Control ownership becomes confused (multiple documents assign ownership to different roles)
- **Residual Risk:** Framework authority collapses

**Risk of parallel control libraries:** If departments maintain their own control frameworks:

- Governance reporting becomes inconsistent (different control counts, different terminology)
- Evidence collection fragments (controls tracked in multiple systems)
- Audit efficiency drops (auditors must reconcile multiple frameworks)
- **Residual Risk:** Non-conformity findings under ISO 27001 Clause 6.1.3 (control selection) and Clause 9.2 (internal audit scope)

**Certification impact:** External certifiers (ISO 27001, ISO 42001, SOC 2 auditors) require:

- A single, auditable control register (the MCM)
- Documented evidence for every control
- Clear control ownership chain
- Absence of competing control taxonomies

If MCM authority fragments, certification bodies will reject the framework.

**Audit defensibility impact:** If MCM control definitions change without coordinated re-validation of dependent documents:

- Downstream documents continue referencing outdated control definitions
- Implemented controls drift from documented intentions
- Evidence collected for old control versions is no longer valid
- **Result:** Audit findings, rework, re-testing, delayed certifications

**Architectural integrity impact:** The EATGF is designed as a control-centric architecture with the MCM as the central hub. All layers derive identity from the MCM. If MCM singularity breaks:

- The framework's unifying principle collapses
- Governance becomes decentralized and duplicative
- Integration and traceability are lost

---

## Official References

This MCM is aligned with the following primary standards (no secondary sources or summaries):
...
- **NIST SP 800-218** -- Secure Software Development Framework (SSDF). National Institute of Standards and Technology, U.S. Department of Commerce.
- **NIST SP 800-53 Revision 5** -- Security and Privacy Controls for Information Systems and Organizations. NIST, U.S. Department of Commerce.
...
- **OWASP ASVS v4.0** -- Application Security Verification Standard. Open Worldwide Application Security Project.
...
| **Status**                  | MCM v1.0-Foundation -- Conformant to EATGF Document Signature Template |
| **EATGF Baseline Relation** | Defines the EATGF baseline and central control authority               |
| **Authority**               | Board of Directors / Executive Steering Committee                      |
| **Next Review**             | August 2026 (or upon material control changes)                         |
