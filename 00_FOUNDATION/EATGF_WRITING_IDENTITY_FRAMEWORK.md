...
| MCM Reference | EATGF-GOV-DOC-005 |
...
- "This control mandates role-based access control for all governance artifacts as defined in MCM reference EATGF-SEC-ACC-001."
- "Control EATGF-AI-ETH-001 requires documented bias assessment with evidence provided via attestation record."
...
| GOVERNANCE_FRAMEWORK_README.md | Marketing tone (throughout) | Badges, 🚀🎓🎉❤️, FAQ format, tagline | Full rewrite: remove badges, emoji, FAQ format, marketing tagline; apply EATGF header and institutional tone |
