...
**Classification:** Technical - Internal Use - ARCHIVED REFERENCE MATERIAL
...
**Current MCM contains all 35+ controls as finalized in this expansion work.**

For current control definitions, refer to: **[MASTER_CONTROL_MATRIX.md](../../00_FOUNDATION/MASTER_CONTROL_MATRIX.md)**
